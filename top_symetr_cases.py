...
type_initial_guess_list = [int(1)]
rmin_list = [4]
l_list = [0.74]# 0.7 is not enough, make it 0.74
...
path_to_save = '/s/dep/sms/w/FHG_Programmierbare_Materialien/PlainDutchWeave/chuc_2023_04/JAX_GPU/code/ProgMat_v1/collec_data/c4/sym/'
